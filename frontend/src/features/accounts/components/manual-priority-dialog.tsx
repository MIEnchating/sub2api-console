    ...
    <Dialog open={props.open} onOpenChange={props.onOpenChange}>
      <DialogContent width="medium" className="sm:!w-[min(38rem,calc(100vw-2rem))]">
        ...
        <div className="grid gap-4">
          ...
          <div className="grid gap-3 rounded-lg border border-border/80 bg-background/40 p-3 sm:grid-cols-3">
            <div>
              <div className="text-foreground text-xs font-semibold">实际优先级</div>
              <div className="text-foreground mt-2 h-9 content-center text-center font-semibold tabular-nums">
                {selected ?? "—"}
              </div>
            </div>
