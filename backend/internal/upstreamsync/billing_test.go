...
func TestReadNewAPIKeyUsageUsesFlowAggregationByStableTokenID(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(writer http.ResponseWriter, request *http.Request) {
		...
		case "/api/data/flow/self":
			...
			_, _ = writer.Write([]byte(`{"success":true,"data":[{"token_id":17,"use_group":"default","model_name":"gpt-5","quota":400000},{"token_id":17,"use_group":"default","model_name":"gpt-5-mini","quota":100000},{"token_id":18,"use_group":"default","model_name":"gpt-5","quota":0}]}`))
		default:
	...
	if err != nil || flowCalls != 1 || values.Keys["17"].Cost != 1 || values.Keys["18"].Cost != 0 || values.Keys["17"].Source != "newapi-token-flow" || values.QuotaPerUnit != 500000 {
