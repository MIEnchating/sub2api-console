...
func (s *Store) ensureSchema(ctx context.Context) error {
 ...
 worker_id TEXT NOT NULL, worker_lease TEXT NOT NULL, automatic INTEGER NOT NULL, worker_revision INTEGER NOT NULL, parent_id TEXT NOT NULL, payload BLOB)`,
		...
		`CREATE TABLE IF NOT EXISTS dictionary_entries (
			id TEXT PRIMARY KEY, kind TEXT NOT NULL, name TEXT NOT NULL, value TEXT NOT NULL,
			description TEXT NOT NULL DEFAULT '', enabled INTEGER NOT NULL DEFAULT 1,
			sort_order INTEGER NOT NULL DEFAULT 0, created_at TEXT NOT NULL, updated_at TEXT NOT NULL,
			version INTEGER NOT NULL DEFAULT 1, UNIQUE(kind, value)
		)`,
		`CREATE INDEX IF NOT EXISTS ix_dictionary_entries_kind_order ON dictionary_entries(kind, sort_order, name)`,
