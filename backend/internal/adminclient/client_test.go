...
func TestRequestDetailsSkipsUsageWhenNoSuccessNeedsEnrichment(t *testing.T) {
	for _, items := range []string{`[]`, `[{"account_id":41,"request_id":"error","kind":"error"}]`, `[{"account_id":41,"request_id":"success","kind":"success","group_id":7,"first_token_ms":1000,"input_tokens":10,"output_tokens":5}]`} {
